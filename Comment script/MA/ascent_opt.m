...
T = interp1(launcher.T_time, launcher.T, t); % Thrust linear interpolation
mdot = T/(launcher.isp*orbit.g); % mass flow rate 
...
CD = 0.49; % avarage CD evaluated with base simualtor 
alpha = 0;   
if isnan(rho)
    rho = 0;
end
