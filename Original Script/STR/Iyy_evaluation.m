...
% I consider a cylinder for each stage
% first I evaluate the Iyy considering each stage both full and empty and interpolating linearly
% then I evaluate the Iyy for each second of burning considering a mean mass flow rate for each second
